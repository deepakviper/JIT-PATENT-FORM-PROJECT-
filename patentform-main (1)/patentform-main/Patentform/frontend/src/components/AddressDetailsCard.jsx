...
function AddressDetailsCard({ previewData, onChange, user, onUserUpdate }) {
  ...
  return (
    <div className="card address-details-card" style={{ padding: '24px', backgroundColor: '#FFF', borderRadius: '12px', border: '1px solid #E5E7EB', display: 'flex', flexDirection: 'column', minHeight: '340px', maxHeight: '360px', overflow: 'hidden' }}>
